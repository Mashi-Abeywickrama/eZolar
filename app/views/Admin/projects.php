                ...
                foreach($results as $row){
                    echo '<div class="project-box">
                                ...
                                <div class="project-details-btn-container">
                                    <a href="/ezolar/AdminProject/projectDetailsPage/'.$row -> projectID.'">
...
<script>
    ...
    ongoing_btn.classList.add('select');
    ongoing_projects.classList.remove('hide');
    ongoing_projects.classList.add('select');
