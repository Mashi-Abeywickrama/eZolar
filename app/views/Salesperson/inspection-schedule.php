...
<div class="body-container">
    <div class="left-panel">
        ...
        <div class="rest">
            ...
            <a href="<?=URLROOT?>/SalespersonSchedules/InspectionSchedule"><div class="box3" style="color: #ffffff;background-color: #0b2f64;">
                Inspection Schedule
            </div></a>
...
<div class="common-main-container">
    <div class="clandar-header-container">
            <span class="calendar-header-text"><?php echo $calendar->getMonthName().' '.$calendar->getYear();
                ...
                $nextMonthLink = '/ezolar/SalespersonSchedules/InspectionBrowse/'.$nextMonth[1].'/'.$nextMonth[0];
                $prevMonth = $calendar->getPrevMonth();
                $prevMonthLink = '/ezolar/SalespersonSchedules/InspectionBrowse/'.$prevMonth[1].'/'.$prevMonth[0];
                ?></span>
