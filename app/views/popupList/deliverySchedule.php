...
<div id="id06" class="modal">
    ...
    <form class="modal-content" id="sch" action="./../scheduleDeliveryDate?project_id=<?php echo $_GET['project_id'] ?>" method="POST">
    
      <div class="container">
          <h1>Delivery Scheduling</h1>
          <p>We kindly request you to select three dates for Delivery and Installation at your convenience. Thank you!</p>
